      ...
      <div class="row-fluid sortable">
            <div class="box span12">
              <div class="box-header" data-original-title>
                  <h2><i class="halflings-icon plus-sign"></i><span class="break"></span>Add new customer</h2>
                <div class="box-icon">
              ...
              <?php echo form_open('Home_controller/save',['class'=>'form-horizontal']); ?>
                  <fieldset>
                    ...
                    <!--button type="submit" class="btn btn-primary">Save changes</button-->
                      <?php echo form_submit(['value'=>'Save Record','class'=>"btn btn-primary"]); ?>
                      <?php echo form_reset(['value'=>'Clear','class'=>"btn btn-warning"]); ?>
